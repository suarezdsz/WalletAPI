...
const { Biometric } = require('../app/controller/auth/biometric.controller');
//validator
    // -- Auth
...
//route categories
router.get(  url + '/product', getProduct );
router.get(  url + '/product/:id', getByIDProduct );
router.delete(  url + '/product/:id', deleteProduct );
router.put(  url + '/product/:id', putProduct );
router.post( url + '/product', validatorProduct, postProduct );
